...
public class SerieService {
    ...
    @Transactional
    public Serie addSerieWithActoresAndProductor(RequestSerieConActoresDTO serieDTO) {

        // Verifica que se proporcione un nombre válido para la serie
        if (serieDTO.getName() == null || serieDTO.getName().isEmpty()) {
            throw new IllegalArgumentException("El nombre de la serie es obligatorio");
        }
        ...
        // Con los ID que nos llegan buscar los actores
